...
Pivot the data from wide to long. Consider why the arguments candidate and votes are in quotes, but name is not. The cols argument of pivot_longer, used with a subtraction sign, tells R which columns NOT to convert to long (i.e. keep name as the identifying row variable, convert all others).
